...
//
// ⭐ ตำแหน่งเยลลี่แยกตามแมพ กำหนดมือทั้งหมดที่ MAP_TILE_LAYOUTS
//    แต่ละแมพมี layout ของตัวเองเพราะความเร็วต่างกัน → arc ต่างกัน
// ══════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════
// MAP_TILE_LAYOUTS — ตำแหน่งเยลลี่แยกตามแมพ กำหนดมือทั้งหมด
// ══════════════════════════════════════════════════════════
//
// แต่ละแมพมี layout ของตัวเองเพราะความเร็วต่างกัน
// → arc กระโดดจริงในเกมต่างกัน → ต้องวางเยลลี่ต่างกัน
//
// โครงสร้าง: MAP_TILE_LAYOUTS[mapId][tileCode] = [ จุดเยลลี่, ... ]
//
//   x   : ระยะจากต้น tile (px)  ช่วง 0–TILE_WIDTH (320)
//   y   : ความสูงจากพื้น (px)    0 = พื้น, ยิ่งมาก = ยิ่งสูง
//   r   : รัศมีเยลลี่ (ไม่ระบุ = 10)
//   val : คะแนน (ไม่ระบุ = 7)
//   special : true = เยลลี่โบนัส (สีทอง)
//
// tile 103 (หลุม) ไม่มีเยลลี่เลยทุกแมพ
// ══════════════════════════════════════════════════════════
...
const MAP_TILE_LAYOUTS = {
  ...
  // ════════════════════════════════════════════════════════
  // candy — speed ?  (แก้ x/y ตามความเร็วจริงของแมพนี้)
  // ════════════════════════════════════════════════════════
  candy: {
    101: [
      { x:  20, y: 0 }, { x:  52, y: 0 }, { x:  84, y: 0 },
